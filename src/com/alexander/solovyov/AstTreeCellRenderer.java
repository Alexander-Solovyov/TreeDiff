...
final public class AstTreeCellRenderer extends DefaultTreeCellRenderer {
    private static Color DeleteColor = new Color(170, 30, 30);
    private static Color UpdateColor = new Color(138, 43, 226);
    private static Color MoveColor = new Color(30, 144, 255);
    private static Color InsertColor = new Color(0, 128, 0);
